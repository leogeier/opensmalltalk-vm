/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.3599 uuid: 1a32964f-d425-4ed5-b830-6e8ce3d98688
	(* Compiler-eem.518)
   from
	HostWindowPlugin VMMaker.oscog-eem.3599 uuid: 1a32964f-d425-4ed5-b830-6e8ce3d98688
 */
static char __buildInfo[] = "HostWindowPlugin VMMaker.oscog-eem.3599 uuid: 1a32964f-d425-4ed5-b830-6e8ce3d98688 " __DATE__ ;
...
static const char *moduleName = "HostWindowPlugin VMMaker.oscog-eem.3599 " INT_EXT;
...
/*	Copyright (c) 2005-2024, 3D Immersive Collaboration Consulting, LLC., All
	Rights Reserved.
 */
...
primitiveShowHostWindowRect(void)
{
	...
	if (!(ioShowDisplayOnWindow(((unsigned char *) dispBits), w, h, d, left, right, top, bottom, windowIndex))) {
		primitiveFail();
	}
	if (!(failed())) {
		pop(9);
...
primitiveSqueakWindowHandle(void)
{
	...
	_return_value = /* positiveMachineIntegerFor: */
			(BytesPerWord == 8
				? positive64BitIntegerFor(((usqInt) handle))
...
void* HostWindowPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveNativeDisplayPosition\000\000\000", (void*)primitiveNativeDisplayPosition},
	{(void*)_m, "primitiveNativeDisplaySize\000\000\000", (void*)primitiveNativeDisplaySize},
	{(void*)_m, "primitiveNativeWindowPosition\000\000\000", (void*)primitiveNativeWindowPosition},
	{(void*)_m, "primitiveNativeWindowSize\000\000\000", (void*)primitiveNativeWindowSize},
