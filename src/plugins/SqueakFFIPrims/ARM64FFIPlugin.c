/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3563 uuid: 9d10453d-c96a-4eee-9ed5-0e0c77427f84
	(Compiler-eem.514)
   from
	ThreadedARM64FFIPlugin VMMaker.oscog-eem.3563 uuid: 9d10453d-c96a-4eee-9ed5-0e0c77427f84
 */
static char __buildInfo[] = "ThreadedARM64FFIPlugin VMMaker.oscog-eem.3563 uuid: 9d10453d-c96a-4eee-9ed5-0e0c77427f84 " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3563"
...
static const char *moduleName = "ARM64FFIPlugin VMMaker.oscog-eem.3563 " INT_EXT;
static sqInt nilObj;
...
ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass, CalloutState *calloutState)
{
	...
	if (((((calloutState->ffiArgHeader)) & FFIFlagStructure) != 0)) {
		...
		if (ptrClass == (classExternalAddress())) {
			...
			if ((structSize <= availableRegisterSpace)
			 && ((structSize <= 16)
			 || (structIsHomogenousIntegerArrayOfSizetypeSpecofLength(structSize, argSpec1, argSpecSize)))) {
				if (structSize <= availableRegisterSpace) {
...
primitiveCallout(void)
{
    ...
    extern void callAndReturnWithStructAddr(void *structAddr, void *procAddr, void *arrayAddr);
...
#      endif
	...
	vmHandle = disownVM(/* disownFlagsFor: */
			(((((calloutState->callFlags)) & FFICallFlagThreaded) != 0)
	...
	if (((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1))
	 || (((((calloutState->ffiRetHeader)) & (FFIFlagPointer + FFIFlagStructure)) == FFIFlagStructure)
	 && (structIsHomogenousFloatArrayOfSizetypeSpecofLength(((calloutState->ffiRetHeader)) & FFIStructSizeMask, ((unsigned int *) (firstIndexableField((calloutState->ffiRetSpec)))), ((specSize = byteSizeOf((calloutState->ffiRetSpec)))) / (sizeof(unsigned int)))))) {
		(floatRet.d = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((struct dprr (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5], ((calloutState->integerRegisters))[6], ((calloutState->integerRegisters))[7]));
...
#endif /* SPURVM */
		memcpy(firstIndexableField(oopSqInt), (&floatRet), (calloutState->structReturnSize));
	...
	if (((calloutState->structReturnSize)) > (2 * BytesPerWord)) {
		...
		structRet = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((SixteenByteReturnII (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5], ((calloutState->integerRegisters))[6], ((calloutState->integerRegisters))[7]);
		intRet = (structRet.a);
	}
	if (isCalleePopsConvention((calloutState->callFlags))) {
		setsp((calloutState->argVector));
	...
	if (((((calloutState->ffiRetHeader)) & (FFIFlagPointer + FFIFlagStructure)) != 0)) {
		...
		longLongRetPtr = ((calloutState->structReturnType)
					? ((char *) ((&structRet)))
					: (calloutState->limit));
		...
		retOop = popRemappableOop();
#endif /* SPURVM */
		memcpy(firstIndexableField(oopSqInt), longLongRetPtr, (calloutState->structReturnSize));
		storePointerofObjectwithValue(0, retOop, oopSqInt);
		result = retOop;
		goto l3;
	}
