/* Automatically generated by
	...
	(Compiler-eem.527)
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3726 uuid: df260b88-5339-458c-9731-cb84179ff32a
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3726 uuid: df260b88-5339-458c-9731-cb84179ff32a " __DATE__ ;
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3726 " INT_EXT;
static sqInt nilObj;
...
l4:
	...
	if ((((calloutState->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) == FFIFlagStructure) {
		...
		registerType = (((calloutState->structReturnSize)) <= (WordSize * 2)
					...
					: /* We cannot return via register, struct is too big */ 6);
